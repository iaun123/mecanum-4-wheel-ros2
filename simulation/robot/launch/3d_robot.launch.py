...
def generate_launch_description():
    ...
    world_file = os.path.join(robot_dir, "worlds", "home.world")
    rviz_file = os.path.join(robot_dir, "rviz", "basic.rviz")
    
    # Pose where we want to spawn the robot
    spawn_x_val = '0.0'
    spawn_y_val = '0.0'
    spawn_z_val =  '0.006473' #0.006456 0.106458 0.006481
    spawn_yaw_val = '0.0'
    ...
    env_var = SetEnvironmentVariable("GAZEBO_MODEL_PATH", robot_share)
    ...
    robot_localization_node = launch_ros.actions.Node(
       ...
       output='screen',
       parameters=[os.path.join(robot_share, 'config/3d_ekf.yaml'), 
